...
class Application{
    ...
    public function __construct() {
        ...
        $identityName = empty($arrPath[0]) ? "Product" : ucfirst($arrPath[0]);
        $action = (empty($arrPath[1]) ? "home" : $arrPath[1]).ucfirst(strtolower($_SERVER["REQUEST_METHOD"]));
